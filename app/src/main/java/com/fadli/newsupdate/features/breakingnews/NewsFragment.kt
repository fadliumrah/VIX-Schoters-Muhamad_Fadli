...
import com.fadli.newsupdate.MainActivity
import com.fadli.newsupdate.R
import com.fadli.newsupdate.WebViewActivity
import com.fadli.newsupdate.databinding.FragmentBreakingNewsBinding
import com.fadli.newsupdate.shared.ListAdapter
import com.fadli.newsupdate.util.Resource
import com.fadli.newsupdate.util.exhaustive
import com.fadli.newsupdate.util.showSnackbar
...
class NewsFragment : Fragment(R.layout.fragment_breaking_news),
    ...
    private val viewModel: NewsViewModel by viewModels() /* property delegates */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val newsArticleAdapter = ListAdapter(
            onItemClick = { article ->
        ...
        binding.apply {
            ...
            viewLifecycleOwner.lifecycleScope.launchWhenStarted {
                viewModel.events.collect { event ->
                    when (event) {
                        is NewsViewModel.Event.ShowErrorMessage -> showSnackbar(
                            getString(
                                R.string.could_not_refresh,
